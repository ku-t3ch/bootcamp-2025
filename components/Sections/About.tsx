...
const About = () => {
  return (
    <div className="bg-linear-to-t from-black to-[#110622] bg-no-repeat bg-cover bg-center flex flex-col lg:flex-row items-center justify-center py-20 relative px-5">
      ...
      <div className="text-white space-y-5 z-10">
        <h1 className="space-x-2 text-4xl lg:text-5xl">
          <span className="text-[#FFDCC9] [font-family:var(--font-anta)]">
            BOOTCAMP
          </span>
          <span className="font-medium">คืออะไร?</span>
        </h1>
        <p className="font-medium text-lg lg:text-2xl max-w-[700px]">
